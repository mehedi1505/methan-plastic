...
import {messageClear,bom_add,get_product,get_items,get_unit_item_name,bom_details_get,bom_details_item_delete,get_product_name_by_id} from '../../../store/reducers/bomReducer'
      ...
      <div className="flex flex-wrap w-[98%] mx-auto">
          <div className="w-full">
            ...
            <div className="flex justify-between items-center bg-[#283046] py-2 md:px-[2px] text-white">
                <div className="pl-2 font-bold text-2xl">Bom Create & Update</div>
            ...
            <div className='relative bg-[#283046] overflow-x-auto min-h-[333px]'>
